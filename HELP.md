...
* [JOOQ Access Layer](https://docs.spring.io/spring-boot/docs/3.1.2/reference/htmlsinge/index.html#data.sql.jooq)
...
```
$ docker run --rm -p 8080:8080 buylocal:0.0.1-SNAPSHOT
```
